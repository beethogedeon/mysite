                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            <ul className="extra-skills wow fadeInUp delay-0-2s pb-30">
                                ...
                                <li><i><RiHeadphoneLine size={16} /></i>Number:+22966301740</li>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="text" id="name" name="name" className="form-control" defaultValue="" placeholder="John Doe" required="" data-error="Please enter your Name" />
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="email" id="email" name="email" className="form-control" defaultValue="" placeholder="johndoe@gmail.com" required="" data-error="Please enter your Email" />
